...
import { TYPEORM_ENTITY_REPOSITORY } from './typeorm-ex.decorator'
    ...
    for (const repository of repositories) {
      ...
      providers.push({
        ...
        useFactory: (dataSource: DataSource): typeof repository => {
          ...
          if (!(dataSourceName in customRepositories)) customRepositories[dataSourceName] = {}
          customRepositories[dataSourceName][repository.name] = customRepository
...
// export function getCustomRepository<T>(repository: ObjectType<T>, dataSourceName: string): T {
